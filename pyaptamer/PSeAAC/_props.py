...
def aa_props(type="numpy", normalize=True):
    ...
    normalize : bool, default=True
        If True, returns z-score normalized properties (column-wise).

    Returns
    -------
    props : pandas.DataFrame or numpy.ndarray
        Amino acid property matrix. Rows are amino acids, columns are properties.
